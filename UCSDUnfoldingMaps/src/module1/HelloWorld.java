...
public class HelloWorld extends PApplet
{
	...
	public static String mbTilesString = "/home/centos/eclipse-workspace/object-oriented-java-programming/UCSDUnfoldingMaps/data/blankLight-1-3.mbtiles";
	...
	public void setup() {
		size(800, 600, OPENGL);  // Set up the Applet window to be 800x600
		                      ...
		                      // Processing library's P2D drawing
		                      // You'll learn more about processing in Module 3

		// This sets the background color for the Applet.  default (200,200,200)
		// Play around with these numbers and see what happens!
		this.background(200, 200, 200);
		
		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		AbstractMapProvider provider1 = new Microsoft.RoadProvider();
		// Set a zoom level -- default 10
		int zoomLevel = 5;
		...
		map2 = new UnfoldingMap(this, 400, 50, 350, 500, provider1);
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map2.zoomAndPanTo(zoomLevel, new Location(40.2531439f, -3.7241076f)); // 40.2531439,-3.7241076 Pinto Madrid
		// This line makes the map interactive
	...
	public static void main(String[] args) {
		...
		PApplet.runSketch(new String[]{"Processing Map"}, pt);
	}
