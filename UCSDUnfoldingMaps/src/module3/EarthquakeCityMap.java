...
public class EarthquakeCityMap extends PApplet {
	...
	private SimplePointMarker addColorRadiusByMagnitude(SimplePointMarker mk, float magnitude) {
	...
	*/
	private SimplePointMarker createMarker(PointFeature feature) {
		...
		addColorRadiusByMagnitude(marker, mag);
	...
	private void addKey() {
		...
		String light = "Below 4.0";
		String moderate = "4.0+ Magnitude";
		String strong = "5.0+ Magnitude";
	...
	public static void main(String[] args) {
		module3.EarthquakeCityMap pt = new module3.EarthquakeCityMap();
